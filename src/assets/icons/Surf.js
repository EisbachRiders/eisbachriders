...
const SurfIcon = ({ className, width, height, fill, viewBox }) => (
  <svg
    width={width}
    height={height}
    ...
    className={className}
  >
    <title id="title_twitter">Surf Icon</title>
    <path
      fill={fill}
      d="M495.487,381.376c-114.617,0.044-191.828-40.025-211.837-109.907c-14.51-50.677,5.895-121.064,58.993-123.655
